...
def cse580_pipeline():
    input_path = 'azureml://datastores/cse580_bs/paths/main_list.txt'
    ...
    command_job = command(
        ...
        command='python process_data.py --input ${{inputs.input_data}}',
...
def create_environment():
    ...
    packages = CondaDependencies.create(python_version=config.PYTHON_VERSION, pip_packages=required)
...
def main():
    ...
    if ci_cd:
        ...
        job_schedule = JobSchedule(name=schedule_name, trigger=cron_trigger, create_job=pipeline_job)
